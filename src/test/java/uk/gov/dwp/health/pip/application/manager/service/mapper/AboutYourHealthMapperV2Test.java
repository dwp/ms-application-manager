...
class AboutYourHealthMapperV2Test {
  ...
  private RegistrationSchema100 registrationSchema;

  @BeforeEach
  void beforeEach() {
    var formCommons = new FormCommons(new ObjectMapper());
    aboutYourHealthMapperV2 = new AboutYourHealthMapperV2(new AddressMapperV2(formCommons));
  }
  ...
  class AboutYourHealthToApiTest {
    ...
    void when_valid_data() {
      var aboutYourHealthDto =
          aboutYourHealthMapperV2.toDto(registrationSchema.getAboutYourHealth());
  ...
  class HealthProfessionalToApiTest {
    ...
    private void verifyHealthProfessional(AboutYourHealthDto aboutYourHealthDto) {
      ...
      assertThat(healthProfessionals.size()).isEqualTo(3);

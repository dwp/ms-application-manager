...
@Tag("unit")
class AboutYourHealthMapperV4Test {
  
  private AboutYourHealthMapperV4 aboutYourHealthMapperV4;
  private RegistrationSchema140 registrationSchema;
  
  @BeforeEach
  void beforeEach() {
    var formCommons = new FormCommonsV2(new ObjectMapper());
    aboutYourHealthMapperV4 = new AboutYourHealthMapperV4(new AddressMapperV4(formCommons));
  }
  ...
  class AboutYourHealthToApiTest {
    ...
    void when_valid_data() {
      uk.gov.dwp.health.pip.application.manager.openapi.registration.v4.dto.AboutYourHealthDto aboutYourHealthDto =
        aboutYourHealthMapperV4.toDto(registrationSchema.getAboutYourHealth());
  ...
  class HealthProfessionalToApiTest {
    ...
    void beforeEach() throws IOException {
      registrationSchema =
        getNewRegistrationDataFromFile("mapping/healthProfessionalConsentGiven.json");
    }

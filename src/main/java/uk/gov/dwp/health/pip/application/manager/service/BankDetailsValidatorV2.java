...
@Service
@Slf4j
public class BankDetailsValidatorV2 {

  private final DefaultApi api;
  private Map<AdditionalInformationDto.SeverityEnum,
      Map<Integer,
      BankDetailsValidity>> severityToCodesMap = new EnumMap<>(
          AdditionalInformationDto.SeverityEnum.class
      );
  ...
  public BankDetailsValidityList validate(
    ...
    try {
      ...
      // see
      // https://dwpdigital.atlassian.net/wiki/spaces/BV/pages/20783530587/Response+Types
  ...
  private BankDetailsValidity getResult(
      final AdditionalInformationDto.SeverityEnum severity,
      final String code
  ) {
  ...
  public Map<AdditionalInformationDto.SeverityEnum,
      Map<Integer,
      BankDetailsValidity>> getSeverityToCodesMap() {

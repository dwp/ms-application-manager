...
import uk.gov.dwp.health.pip.application.manager.openapi.registration.v4.dto.HistoryDto;
import uk.gov.dwp.health.pip.application.manager.openapi.registration.v4.dto.HistoryDto.StateEnum;
import uk.gov.dwp.health.pip.application.manager.openapi.registration.v4.dto.StateDto;
import uk.gov.dwp.health.pip.application.manager.openapi.registration.v4.dto.StateDto.CurrentStateEnum;
